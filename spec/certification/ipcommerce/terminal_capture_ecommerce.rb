...
describe VaultedBilling::Gateways::Ipcommerce do
  ...
  context "Authorization Tests" do
    ...
    context 'A1' do
      let(:code) { "#{batch}_A1" }
      let(:amount) { 2.00 }
      let(:credit_card) { Factory.build(:terminal_credit_card, :card_number => '4111111111111111', :cvv_number => '111', :postal_code => '10101') }
    ...
    context 'A2' do
      let(:code) { "#{batch}_A2" }
      let(:amount) { 2.50 }
      let(:credit_card) { Factory.build(:terminal_credit_card, :card_number => '5454545454545454', :cvv_number => '111', :postal_code => '10101') }
    ...
    context 'A3' do
      let(:code) { "#{batch}_A3" }
      let(:amount) { 5.00 }
      let(:credit_card) { Factory.build(:terminal_credit_card, :card_number => '371449635398456', :cvv_number => '1111', :postal_code => '10101') }
    ...
    context 'A5' do
      let(:code) { "#{batch}_A5" }
      let(:amount) { 2.15 }
      let(:credit_card) { Factory.build(:terminal_credit_card, :card_number => '5454545454545454', :cvv_number => nil, :postal_code => '10101') }
    ...
    context 'A6' do
      let(:code) { "#{batch}_A6" }
      let(:amount) { 10.83 }
      let(:credit_card) { Factory.build(:terminal_credit_card, :card_number => '371449635398456', :cvv_number => 777, :postal_code => '10101') }
  ...
  context "ReturnById Tests" do
    ...
    let(:b1_credit_card) { Factory.build(:terminal_credit_card, :card_number => '4111111111111111', :cvv_number => '111', :postal_code => '10101') }
    ...
    let(:b4_credit_card) { Factory.build(:terminal_credit_card, :card_number => '5454545454545454', :cvv_number => '111', :postal_code => '10101') }
  ...
  context "Undo (Void) Tests" do
    ...
    let(:c1_credit_card) { Factory.build(:terminal_credit_card, :card_number => '5454545454545454', :cvv_number => '111', :postal_code => '10101') }
    ...
    let(:c3_credit_card) { Factory.build(:terminal_credit_card, :card_number => '4111111111111111', :cvv_number => '111', :postal_code => '10101') }
    ...
    let(:c5_credit_card) { Factory.build(:terminal_credit_card, :card_number => '5454545454545454', :cvv_number => '111', :postal_code => '10101') }
    ...
    let(:c7_credit_card) { Factory.build(:terminal_credit_card, :card_number => '4111111111111111', :cvv_number => '111', :postal_code => '10101') }
  ...
  context "Non-Standard Card Tests" do
    ...
    let(:d1_credit_card) { Factory.build(:terminal_credit_card, :card_number => '6011000995504101', :cvv_number => '111', :postal_code => '10101') }
    let(:d2_authorization) { gateway.authorize(nil, d2_credit_card, 33.03, options) }
    let(:d2_credit_card) { Factory.build(:terminal_credit_card, :card_number => '4111111111111111', :postal_code => '10101') }
    let(:d3_authorization) { gateway.authorize(nil, d3_credit_card, 34.02, options) }    
    let(:d3_credit_card) { Factory.build(:terminal_credit_card, :card_number => '4111111111111111', :postal_code => '10101') }
  ...
  context "Secure Card Data Tokenization Tests" do
    ...
    let(:i2_credit_card) { Factory.build(:terminal_credit_card, :card_number => '5454545454545454', :cvv_number => '111', :postal_code => '10101') }
    let(:i3_authorization) { gateway.authorize(nil, i3_credit_card, 1.00, options) }
    let(:i3_credit_card) { Factory.build(:terminal_credit_card, :card_number => '371449635398456', :cvv_number => '1111', :postal_code => '10101') }
    ...
    it "outputs the result" do
      ...
      puts IpcommerceTransaction.new("#{batch}_I6", i6_refund).print
